                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    <span class="submit-btn">
                                        <input type="submit" style="margin:0px;" class="button-secondary" value="@lang('menu-builder::messages.choose')">
                                    </span>
                                                                    ...
                                                                    <li id="menu-item-{{ $m->id }}"
                                                                        ...
                                                                        <dl class="menu-item-bar">
                                                                            <dt class="menu-item-handle">
                                                                                <span class="item-title">
                                                                                    ...
                                                                                    <span class="is-submenu" style="@if ($m->depth == 0) display: none; @endif">@lang('menu-builder::messages.subelement')</span>
                                                                                </span>
                                                                                <span class="item-controls">
                                                                                    ...
                                                                                    <span class="item-order hide-if-js">
                                                                                        <a href="{{ $currentUrl }}?action=move-up-menu-item&menu-item={{ $m->id }}&_wpnonce=8b3eb7ac44"
                                                                                            class="item-move-up">
                                                                                            <abbr title="@lang('menu-builder::messages.move_up')">↑</abbr>
                                                                                        </a>
                                                                                        | <a href="{{ $currentUrl }}?action=move-down-menu-item&menu-item={{ $m->id }}&_wpnonce=8b3eb7ac44"
                                                                                            class="item-move-down">
                                                                                            <abbr title="@lang('menu-builder::messages.move_down')">↓</abbr>
                                                                                        </a>
                                                                                    </span>
                                                                                    <a class="item-edit"
                                                                                        id="edit-{{ $m->id }}"
                                                                        ...
                                                                        <div class="menu-item-settings"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a class="item-cancel submitcancel hide-if-no-js btn btn-warning"
                                                                                    id="cancel-{{ $m->id }}"
                                                                                    href="{{ $currentUrl }}?edit-menu-item={{ $m->id }}&cancel=1424297719#menu-item-settings-{{ $m->id }}">@lang('menu-builder::messages.cancel')</a>
                                                                                {{-- <span class="meta-sep hide-if-no-js"> |</span> --}}
                                                                                <a onclick="getmenus()"
                                                                                    class="button button-primary updatemenu btn btn-success"
                                                                                    id="update-{{ $m->id }}"
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        ...
                                                        @elseif(request()->has('menu'))
                                                            <span class="delete-action"> <a
                                                                    class="submitdelete deletion menu-delete btn btn-danger"
                                                                    onclick="deletemenu()"
